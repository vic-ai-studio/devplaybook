...
NYC sits just below Seattle on pure TC but offers strong compensation across a broader range of industries — finance, media, and advertising all pay competitive engineering salaries.
...
- **Location-adjusted remote:** Pays SF rates regardless of location (rare — Stripe, some startups)
...
For detailed negotiation scripts and email templates, see our guide: [How to Negotiate Your First Tech Offer](/blog/how-to-negotiate-your-first-tech-offer-salary-scripts).

---

## Salary Trends to Watch in 2025
...
1. **Seattle** — High TC + no state tax = best purchasing power after COL
2. **Austin** — Lower TC but no state tax + low COL
3. **San Francisco** — Highest TC, lowest purchasing power after taxes and rent
4. **New York** — High TC, high COL, competitive purchasing power
5. **Boston** — Solid TC, manageable COL
6. **Denver** — Good balance, lower absolute TC
7. **Chicago** — Good value for Midwest cost of living
8. **Remote (adjusted bands)** — Highly variable, depends on company policy

---

## Get Your Offer Analysis Tools

Want to model total compensation across offers? The **[DevToolkit Starter Kit](https://devplaybook.gumroad.com)** includes a salary comparison spreadsheet, offer evaluation framework, and negotiation email templates — everything you need to evaluate competing offers accurately.

For more career guidance, see our [Developer Portfolio Checklist](/blog/developer-portfolio-checklist-20-things-hiring-managers) and [Senior Developer Interview Checklist](/blog/senior-developer-interview-checklist).
