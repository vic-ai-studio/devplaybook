...
description: "Cloud-native CI/CD framework for Kubernetes that defines pipelines as reusable, composable building blocks — declarative YAML tasks, parallel execution, and built-in artifact management."
