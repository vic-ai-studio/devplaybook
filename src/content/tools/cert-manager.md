...
description: "cert-manager automates TLS certificate provisioning, renewal, and management for Kubernetes — supports Let's Encrypt, HashiCorp Vault, and custom CAs."
