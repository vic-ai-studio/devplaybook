...
description: "Kubernetes event-driven autoscaler that scales workloads to and from zero based on external metrics from queues, databases, cloud services, and custom Prometheus queries."
