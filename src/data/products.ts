...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 19,
    description: '58 structured prompt templates for Claude, ChatGPT, and Gemini — organized by use case. Code Review, Debugging, Documentation, Architecture, and 10 model-specific tips. Stop writing prompts from scratch.',
    features: [
      '12 code review prompts (security, performance, API design, IaC, refactoring roadmap)',
      '12 debugging prompts (stack traces, memory leaks, async bugs, production triage)',
      '12 documentation prompts (README, ADR, runbook, post-mortem, migration guide)',
      '12 architecture prompts (system design, caching, event-driven, multi-tenancy)',
      '10 model-specific tips for Claude, ChatGPT, and Gemini',
      '{{PLACEHOLDER}} syntax — replace and paste in under 10 seconds',
      'Works with Claude (Sonnet/Opus), GPT-4o, Gemini 1.5 Pro, and any LLM',
    ],
    faq: [
      { q: 'Which AI models are supported?', a: 'Claude (Sonnet/Opus), GPT-4o, Gemini 1.5 Pro, and any instruction-following LLM. Model-specific tips help you get the best from each one.' },
      ...
      { q: 'How is this different from the AI Developer Prompts Pack?', a: 'The AI Developer Prompts Pack is 55 prompts focused on developer workflows. This toolkit has 58 prompts with deeper coverage across 4 categories plus 10 model-specific tips for Claude, ChatGPT, and Gemini.' },
    ],
    tags: ['ai', 'prompt-engineering', 'llm', 'chatgpt', 'claude', 'gemini', 'code-review', 'debugging'],
    icon: '🤖',
    gumroadUrl: gumroadLink('ai-prompt-engineering-toolkit'),
  },
  {
    slug: 'developer-cheat-sheet-bundle',
    name: 'Developer Cheat Sheet Bundle',
    price: 14,
    description: '10 print-ready cheat sheets for the tools developers use every day: Git, Docker, Linux CLI, SQL, Regex, HTTP Status codes, VS Code shortcuts, Bash scripting, jq/JSON, and Markdown.',
    features: [
      'Git: workflow, branching, stash, rebase, fixing mistakes, useful aliases',
      'Docker: images, containers, Compose, volumes, Dockerfile best practices',
      'Linux CLI: navigation, permissions, processes, networking, text processing, SSH',
      'SQL: SELECT, joins, CTEs, window functions, indexes, PostgreSQL tips',
      'Regex: syntax, quantifiers, groups, lookahead, 12 common patterns, Python/JS/grep examples',
      'HTTP Status Codes: all 2xx–5xx with when-to-use guide, 401 vs 403, response format',
      'VS Code: 60+ shortcuts for editing, navigation, multi-cursor, code intelligence',
      'Bash Scripting: variables, arrays, loops, functions, error handling, common patterns',
      'JSON & jq: filtering, transformation, aggregation, Python/JS examples',
      'Markdown: complete syntax, tables, code blocks, GitHub Flavored Markdown',
      'A4 print-ready format — use on paper or as a desktop split-screen reference',
    ],
    faq: [
      { q: 'Can I print these?', a: 'Yes — all sheets are formatted for A4 print. Dense but readable, designed to work on paper.' },
      { q: 'Are these for beginners?', a: 'Covers beginner to intermediate. Useful as a quick reference for experienced developers too — great for the commands you use but can\'t always remember.' },
      { q: 'What format are the files?', a: 'Markdown files — open in VS Code, Obsidian, Notion, or any text editor. Print via VS Code\'s Markdown preview or any Markdown-to-PDF tool.' },
    ],
    tags: ['cheat-sheet', 'git', 'docker', 'linux', 'sql', 'regex', 'vscode', 'bash', 'reference', 'productivity'],
    icon: '📋',
    gumroadUrl: gumroadLink('developer-cheat-sheet-bundle'),
  },
  {
  ...
  },
  {
    ...
    price: 29,
    description: '210 technical interview questions with model answers across Frontend, Backend, System Design, and DSA. Real questions from Google, Meta, Amazon, and Stripe — with follow-up questions interviewers actually ask. Pay what you want (min $29).',
    features: [
      '55 Frontend questions: HTML/CSS, JavaScript, React, TypeScript, Performance, Accessibility',
      '55 Backend questions: REST APIs, Node.js, Databases, Authentication, Security, System Performance',
      '50 System Design questions: URL shortener, Twitter, YouTube, Uber, WhatsApp, Payment systems',
      '50 DSA questions: Arrays, Trees, Graphs, Dynamic Programming, Stack/Queue, Sorting',
      'Every question includes a model answer, key points, and a real interviewer follow-up',
      'Questions tagged by difficulty: Junior / Mid / Senior',
      'Bilingual: English + Traditional Chinese (繁體中文)',
      'Markdown + PDF-ready format',
    ],
    faq: [
      { q: 'How many questions are included?', a: '210 total: 55 Frontend, 55 Backend, 50 System Design, 50 DSA. Every question has a model answer, key points, and a follow-up question.' },
      { q: 'What does "Pay What You Want" mean?', a: 'The minimum price is $29. You can pay more if you find it valuable — 100% goes to keeping DevPlaybook free.' },
      { q: 'Are these real interview questions?', a: 'Yes — curated from actual interviews at top tech companies (Google, Meta, Amazon, Microsoft, Stripe, Shopify). Questions reflect what interviewers actually ask in 2024-2025.' },
      { q: 'What format are the files?', a: 'Markdown files organized by category (frontend.md, backend.md, system-design.md, dsa.md). Readable in any text editor, GitHub, or Notion. Also includes a bilingual Traditional Chinese version.' },
      { q: 'Is the Chinese version a full translation?', a: 'Yes — all 210 questions are fully translated to Traditional Chinese (繁體中文), including answers and follow-ups. Code snippets remain in English.' },
    ],
    tags: ['interview', 'frontend', 'backend', 'system-design', 'dsa', 'algorithms', 'career'],
    icon: '🎯',
    gumroadUrl: gumroadLink('interview-vault'),
  },
  {
  ...
  {
    slug: 'typescript-quick-reference-toolkit',
    name: 'TypeScript Quick Reference Toolkit',
    price: 14,
    description: '5 practical reference files for TypeScript developers: cheatsheet, TS vs JS comparison, 20 utility types with real examples, tsconfig best practices template, and 15 common mistakes guide. Print it. Keep it on your desk.',
    features: [
      'TypeScript Cheatsheet (A4): basic types, interfaces, generics, functions, union/intersection, enums, classes, async',
      'TypeScript vs JavaScript side-by-side comparison + migration checklist',
      '20 Utility Types with real-world code examples (Partial, Pick, Omit, Record, ReturnType...)',
      '4 custom utility type recipes (DeepPartial, Nullable, WithRequired, template literals)',
      'Production-ready tsconfig.json with all settings explained and preset notes',
      '15 common TypeScript mistakes with before/after code (any abuse, null checks, enums, async...)',
      'Works with VS Code, WebStorm, any TypeScript project',
    ],
    faq: [
      { q: 'Is this for beginners or experienced developers?', a: 'Both. Beginners get the full syntax overview and mistake guide. Experienced devs get the utility types deep-dive and tsconfig best practices.' },
      { q: 'What format are the files?', a: 'Markdown files — open in any editor, VS Code, Obsidian, or convert to PDF with Pandoc or your browser\'s print function.' },
      { q: 'Does the tsconfig work with Next.js / Vite / Node.js?', a: 'Yes — the tsconfig template includes preset notes for each environment with the specific settings to change.' },
      { q: 'Is JavaScript knowledge required?', a: 'Yes — this assumes you know JavaScript basics. TypeScript builds on JS so some JS familiarity is needed.' },
    ],
    tags: ['typescript', 'javascript', 'cheatsheet', 'reference', 'frontend', 'backend', 'developer-tools'],
    icon: '📘',
    gumroadUrl: gumroadLink('typescript-quick-reference-toolkit'),
  },
  {
